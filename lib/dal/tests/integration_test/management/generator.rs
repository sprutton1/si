...
use dal::{
    ...
    management::{
        generator::generate_template, prototype::ManagementPrototype, ManagementFuncReturn,
        ManagementGeometry, ManagementOperator,
    },
    AttributeValue, Component, ComponentId, ComponentType, DalContext, SchemaId,
};
